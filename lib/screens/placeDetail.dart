        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: SliverCarousel(place: widget.place),
            ),
          ),
          SliverToBoxAdapter(
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  PlaceDetailTopRow(place: widget.place),
                  SizedBox(height: 13.h),
                  SecondRowUpper(place: widget.place),
                  Divider(
                  ...
                  buildTitle(' OverView'),
                  SizedBox(height: 5.h),
                  PlaceDetailDescription(place: widget.place),
                  SizedBox(height: 12.h),
                  buildTitle(' Activities'),
                  SizedBox(height: 5.h),
                  PlaceActivities(place: widget.place),
                  SizedBox(height: 5.h),
                ],
              ),
            ),
